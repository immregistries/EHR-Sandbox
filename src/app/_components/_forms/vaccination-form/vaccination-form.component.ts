...
export class VaccinationFormComponent implements OnInit {
  ...
  formCards: FormCard[] = [
    ...
    {title: "Codes",rows: 1, cols: 1, vaccineForms: [
      {type: formType.select, title: "Cvx", attribute: "vaccineCvxCode", codeMapLabel: "VACCINATION_CVX_CODE"},
      {type: formType.select, title: "Ndc", attribute: "vaccineNdcCode", codeMapLabel: "VACCINATION_NDC_CODE_UNIT_OF_USE"},
      // {type: formType.text, title: "", attribute: },
    ]},
    ...
    {title: "Lot",rows: 1, cols: 2, vaccineForms: [
      ...
      {type: formType.select, title: "Manifacturer", attribute: "vaccineMvxCode", codeMapLabel: "VACCINATION_MANUFACTURER_CODE"},
    ...
    {title: "Entering clinician",rows: 1, cols: 2, clinicianForms: [
    ...
    {title: "Ordering clinician",rows: 1, cols: 2, clinicianForms: [
    ...
    {title: "Administering clinician",rows: 1, cols: 2, clinicianForms: [
