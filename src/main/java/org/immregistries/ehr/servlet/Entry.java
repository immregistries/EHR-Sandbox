	    ...
	    try {
	      {
	        ...
	        out.println("<form method=\"post\" action=\"authentication\">\r\n"
                ...
                + "                     <br />\r\n"
                + "                     <br />\r\n"
                + "                     <input type=\"password\" placeholder=\"Manufacturer\" id=\"manufacturer\" name=\"manufacturer\" required value=\"\" size=\"40\" maxlength=\"60\" />\r\n"
                + "                     <br />\r\n"
                + "                     <br />\r\n"
                + "                     <br />\r\n"
                + "                     <input type=\"password\" placeholder=\"Administered Date\" id=\"AdmDate\" name=\"AdmDate\" required value=\"\" size=\"40\" maxlength=\"60\" />\r\n"
                + "                     <br />\r\n"
                + "                     <br />\r\n"
                + "                     <br />\r\n"
                + "                     <input type=\"password\" placeholder=\"Name of EHR User (Clinician)\" id=\"EHRuid\" name=\"EHRuid\" required value=\"\" size=\"40\" maxlength=\"60\" />\r\n"
                + "                     <br />\r\n"
                + "                </fieldset>\r\n"
                + "                <div class=\"ok\">\r\n"
