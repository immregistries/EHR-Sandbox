...
public class HomeServlet extends HttpServlet {
    ...
    try {
      {
        ...
        if (show == null) {
          out.println("<div class=\"w3-panel w3-yellow\"><p class=\"w3-left-align\">This system is for test purposes only. "
                  + "Do not submit production data. This system is not secured for safely holding personally identifiable heath information."
                  + "</p></div>");
          out.println("    <h2>Primary Functions Supported</h2>");
          out.println("    <ul class=\"w3-ul w3-hoverable\">");
          out.println("      <li><a href=\"https://github.com/immregistries/EHR-Sandbox\">Github Repository</a></li>");
          out.println("    </ul>");
        }
        out.println(" </div>");

        out.println("<img src=\"images/markus-spiske-Ds8gp_7-5AM-unsplash.jpg\" class=\"w3-round\" alt=\"Sandbox\" width=\"400\">");
  ...
  public static void doHeader(PrintWriter out, HttpSession session) {
    ...
    out.println( "<a href=\"home\" class=\"w3-bar-item w3-button w3-green\">EHR Sandbox</a>");
