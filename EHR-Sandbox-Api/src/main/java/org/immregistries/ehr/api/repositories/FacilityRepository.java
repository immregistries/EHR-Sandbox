...
public interface FacilityRepository extends CrudRepository<Facility, Integer>, JpaSpecificationExecutor<Facility> {
    ...
    boolean existsByUserIdAndId(@Param("userId") Integer userId, @Param("id") Integer id);

    Iterable<Facility> findByTenantId(Integer tenantId);

    Iterable<Facility> findByParentFacilityId(Integer parentFacilityId);
    ...
    Optional<Facility> findByTenantIdAndNameDisplay(Integer tenantId, String nameDisplay);
